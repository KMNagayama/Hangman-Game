...
function startGame(words) {
    ...
    // Salva a palavra selecionada no sessionStorage
    sessionStorage.setItem('selectedWord', selectedWord);

    // Salva a dica correspondente no sessionStorage
    const hint = selectedHints[selectedWord];
    sessionStorage.setItem('selectedHint', hint);
